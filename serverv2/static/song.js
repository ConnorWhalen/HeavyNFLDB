    ...
    li.innerHTML = (
        '<span class="song-li-left">' +
            '<div class="song-li-thumb-cover">' +
                `<img class="song-li-thumb" src="/static/thumbnails/${song.video_id}/hqdefault.jpg"/>` +
            '</div>' +
        '</span>' +
...
function createSongPreview(song) {
    ...
    preview.innerHTML = (
        ...
        `<div class="song-preview-thumb-cover">` +
            `<img class="song-preview-thumb" src="/static/thumbnails/${song.video_id}/hqdefault.jpg"></img>` +
        '</div>'
    );
...
function playSong(song) {
    ...
    audio.setAttribute('src', `/static/streams/${song.video_id}/playlist.m3u8`);
    audio.play()
