    ...
    li.innerHTML = (
        '<span class="song-li-left">' +
            '<div class="song-li-thumb-cover">' +
                `<img class="song-li-thumb" src="/static/thumbnails/${artist.thumb_video_id}/hqdefault.jpg"/>` +
            '</div>' +
        '</span>' +
...
function createArtistPreview(artist) {
    ...
    preview.innerHTML = (
        ...
        `<div class="song-preview-thumb-cover">` +
            `<img class="song-preview-thumb" src="/static/thumbnails/${artist.thumb_video_id}/hqdefault.jpg"></img>` +
        '</div>'
    );
